    ...
    var Contact = Class.extend({
        ...
        _calcPenetrationDepth: function () {
            ...
            function _chooseNearPoint(points) {
                ...
                nearPoint = detectPointOnLine(points[points.length - 1].vertSub, points[0].vertSub, originPos);
                ...
                for (var i = 1, l = points.length; i < l; i++) {
                    nearPoint = detectPointOnLine(points[i - 1].vertSub, points[i].vertSub, originPos);
            ...
            while (!result) {
                ...
                this._drawTriangle(points[0].vertSub, points[1].vertSub, points[2].vertSub, {
                ...
                //debug
                this._drawPoint(newPoint.vertSub, {
                    color: 'blue'
                });

                for (var i = 0, l = points.length; i < l; i++) {

                    if (vec2.equal(newPoint.vertSub, points[i].vertSub)) {
                        result = newPoint;
                        break;
                    }
                }
        ...
        _isContact: function () {
            ...
            var v0 = this._foundPoints[0].vertSub;
            var v1 = this._foundPoints[1].vertSub;
            var v2 = this._foundPoints[2].vertSub;
        ...
        _getNearPoint: function () {
            ...
            var originPos = this._originPos;
            var nearPoint0 = Phys2D.detectPointOnLine(this._foundPoints[0].vertSub, this._foundPoints[1].vertSub, originPos);
            var nearPoint1 = Phys2D.detectPointOnLine(this._foundPoints[0].vertSub, this._foundPoints[2].vertSub, originPos);
        ...
        _checkCenterInTriangle: function () {
            ...
            if (this._isContact()) {
                ...
                this._drawPoint(depth.vertSub, {
                    color: 'yellow'
                });
                console.log(vec2.norm(depth.vertSub));
                return true;
            }
            ...
            for (var i = 0, l = this._foundPoints.length; i < l; i++) {
                if (vec2.equal(ful.vertSub, this._foundPoints[i].vertSub)) {
                    return false;
                }
            }
        ...
        _slicePoints: function () {
            ...
            for (var i = 0, l = points.length; i < l; i++) {
                len = vec2.norm(points[i].vertSub);
        ...
        _detect: function () {
            ...
            //求まった点と原点を結んだベクトルのサポート写像を求める
            support = vec2.sub(originPos, ful.vertSub);
            ...
            if (vec2.equal(this._foundPoints[0].vertSub, this._foundPoints[1].vertSub)) {
                this._nocontact();
                return false;
            }

            //求まった2つの点で作られる線分の最接近点を求める
            var nearPoint = Phys2D.detectPointOnLine(this._foundPoints[1].vertSub, this._foundPoints[0].vertSub, originPos);
