(function (ns) {
    ...
    var Contact = Class.extend({
        ...
        _calcNearPointTriangle: function (depthPoint) {
            ...
            //TODO それぞれの最接近点を求める。頂点の場合はそれを、エッジの場合はその頂点をそれぞれ最近接点として保持。
            //頂点情報がワールド座標系なので、ローカルに戻す処理を入れる
        ...
        _checkCenterInTriangle: function () {
            ...
            nearPoint0 = ns.detectPointOnLine(this._foundPoints[0], this._foundPoints[1], originPos);
            nearPoint1 = ns.detectPointOnLine(this._foundPoints[0], this._foundPoints[2], originPos);
            nearPoint2 = ns.detectPointOnLine(this._foundPoints[1], this._foundPoints[2], originPos);
        ...
        detect: function () {
            ...
            //debug
            // this._drawLine(this._foundPoints[1], this._foundPoints[0]);
