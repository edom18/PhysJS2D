(function (ns) {
    ...
    var Solver = Class.extend({
        ...
        _calcImpulse: function () {
            ...
            var iIA = 1 / objA.inertia;
            var iIB = 1 / objB.inertia;
            ...
            var dva = vec2.multiplyScalar(iN, (1 / massA) * J);
            var doa = iIA * vec2.cross(_r1, n) * J;
            var dvb = vec2.multiplyScalar(iN, (-1 / massB) * J);
            var dob = -iIB * vec2.cross(_r2, n) * J;
