...
(function (ns) {
    ...
    var Solver = Class.extend({
        ...
        _solveConstraints: function () {
            ...
            var timeStep = this._timeStep / 1000;
            ...
            for (var i = 0, l = rigidbodies.length; i < l; i++) {
                ...
                if (Math.abs(body.velocity.x) < ns.LINEAR_VELOCITY_TOLERANCE) {
                    body.velocity.x = 0;
                }
                if (Math.abs(body.velocity.y) < ns.LINEAR_VELOCITY_TOLERANCE) {
                    body.velocity.y = 0;
                }
                if (Math.abs(body.angularVelocity) < ns.ANGULAR_VELOCITY_TOLERANCE) {
