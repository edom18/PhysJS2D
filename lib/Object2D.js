(function (ns) {
    ...
    var Object2D = Class.extend({
        ...
        update: function (timeStep) {
            ...
            //msからsに変換
            var _timeStep = timeStep / 1000;

            //回転の更新
            this.angularVelocity += this.angularAcc * _timeStep;
            this.rotate(this.angularVelocity * _timeStep);

            //速度の更新
            var acc = vec2.multiplyScalar(this.acceleration,  _timeStep);
            this.velocity = vec2.add(this.velocity, acc);
            this.translate(vec2.multiplyScalar(this.velocity, _timeStep));
        },
